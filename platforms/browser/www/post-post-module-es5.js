...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["post-post-module"], {
  ...
  function srcAppPostPostPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var PostPage = /*#__PURE__*/function () {
      function PostPage(camera, userService) {
      ...
      _createClass(PostPage, [{
        ...
        value: function takePic(sourceType) {
          ...
          this.camera.getPicture(options).then(function (imageData) {
            ...
            self.cam = true;
            self.post = false;
            var picture = firebase__WEBPACK_IMPORTED_MODULE_4__["storage"]().ref(_this.randomId);
        ...
        value: function makePost() {
          ...
          setTimeout(function () {
            _this2.img = "assets/test.png";
            _this2.cam = false;
            _this2.post = true;
            _this2.caption = "";
            _this2.randomId = Math.random().toString(36).substr(2, 5);
          }, 500);
        }
      }]);
